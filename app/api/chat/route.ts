...
export async function POST(req: Request) {
  try {
    ...
    // Debug log to track incoming messages
    console.log('[DEBUG] Chat API - Messages received:', messages.length, 'messages');
    console.log('[DEBUG] Chat API Response:', { userId, hasUserContext: !!userContext });
    ...
    // The Vercel AI SDK handles all the formatting internally
